...
<img src="./assets/illustrations/spreadsheet.png" alt="Colorful spreadsheet" style="width: 50%; margin-right: 2rem; float: left;">
...
<img src="./assets/illustrations/box-of-spreadsheets.png" alt="A box with a spreadsheet on the side" align="right" width="50%">

Every time a blockchain "spreadsheet" makes an update, it keeps the old version of the sheet and adds a new one to the list. Every block is like a box with the updated spreadsheet in it. The process is roughly:
